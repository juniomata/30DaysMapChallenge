...
agg_png("output/3D_Tambora_Annotated.png", width = 1000, height = 800, res = 144)

# Start a new plot
grid.newpage()
grid.raster(image_3d)

# Overlay Title
grid.text(
  "Tambora Volcano", 
  x = unit(0.03, "npc"), y = unit(0.93, "npc"), 
  just = "left", gp = gpar(fontfamily = "merriweather", fontsize = 41, col = "#333333", fontface = "bold")
)
...
grid.text(
  ...
  x = unit(0.03, "npc"), y = unit(0.85, "npc"), 
  just = "left", gp = gpar(fontfamily = "sans", fontsize = 14, col = "#555555", lineheight=0.6)
)
...
grid.text(
  ...
  just = "right", gp = gpar(fontfamily = "sans", fontsize = 10, col = "#777777", lineheight=0.5)
)
